...
export function MainContent({ user, project }: MainContentProps) {
  ...
  console.log('[MainContent] Rendering, panelStorage:', panelStorage);
  console.log('[MainContent] typeof window:', typeof window);

  return (
    <FileSystemProvider initialData={project?.data}>
      <ChatProvider projectId={project?.id} initialMessages={project?.messages}>
        <div className="h-screen w-screen overflow-hidden bg-neutral-50">
          <ResizablePanelGroup direction="horizontal" className="h-full" storage={panelStorage}>
            {/* Left Panel - Chat */}
